...
for n_s in [100, 200, 500, 1000, 2000]:
    ...
    dat_source, dat0, dat0_full, dat_test = sim_data(n_s=n_s, n_0=50, n_test=5000, d=d, sig=0.5, 
...
res_full.to_csv('./Results/Simulation_Concept_Covariate_'+str(job_id)+'_Compare.csv', index=False)